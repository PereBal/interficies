  ...
  <body>
    <main>
      ...
      <div class="row" style="margin-top:3em;">
        ...
        <div class="col s8 offset-s3">
          <div class="col s10 err-page-error white-text text-darken-1 center-align">
            Ooups! La página que está buscando no se encuentra disponible. <i class="fa fa-frown-o"></i>
          </div>
        </div>
      </div>
    </main>
